...
dt = 1.0 # reduce if solver does not converge
...
update_forcings(t_export * checkpoint)
solverObj.load_state(checkpoint, outputdir=output_dir, t=t_export * checkpoint)
